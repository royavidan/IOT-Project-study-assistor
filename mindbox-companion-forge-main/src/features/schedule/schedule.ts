...
export interface ScheduleEvent {
  ...
  /** Study blocks only: true when auto-generated by the planner (safe to regenerate). */
...
export interface ScheduleOccurrence {
  ...
  notes: string | null;
  kind: ScheduleKind;
  /** Study occurrences only: true when auto-generated by the planner. */
  planGenerated: boolean;
}
...
export interface AgendaItem {
  ...
  subtype?: string | null;
  /** Study items only: planner-generated blocks render as slim rows. */
  planGenerated?: boolean;
}
...
function toOccurrence(event: ScheduleEvent, date: string): ScheduleOccurrence {
  return {
    ...
    notes: event.notes,
    kind: event.kind,
    planGenerated: event.planGenerated ?? false,
  };
}
